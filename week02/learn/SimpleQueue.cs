public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: This attempted to find and dequeue for value at index 1 when it was at index 0 (the first item);
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Items were enqued from the front instead of the back
        ...
        // Defect(s) Found: I got the exception as expected. 
    }
